...
public class OpacContentProvider implements PlatformContributor {
	public static final String CONTENT_CONTROL = OpacContentProvider.class
			.getName() + "#CONTENT";

	private final ServiceProvider serviceProvider;

	public OpacContentProvider(ServiceProvider serviceProvider) {
		this.serviceProvider = serviceProvider;
	}
	
	
	public ServiceProvider getServicePrivider(){
	...
	public Control createUIControl(Composite parent) {			
		...
		ContributorService pageService = serviceProvider
