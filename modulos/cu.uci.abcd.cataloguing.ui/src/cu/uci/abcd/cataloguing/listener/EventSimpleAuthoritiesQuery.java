...
public class EventSimpleAuthoritiesQuery implements Listener {
	...
	public EventSimpleAuthoritiesQuery(ProxyController controller, String dataBaseName, Composite view,
			Text textBox){
