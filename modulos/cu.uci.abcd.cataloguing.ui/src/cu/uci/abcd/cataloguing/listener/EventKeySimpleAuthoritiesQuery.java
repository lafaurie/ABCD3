...
public class EventKeySimpleAuthoritiesQuery implements KeyListener {
	...
	public EventKeySimpleAuthoritiesQuery(ProxyController controller, String dataBaseName, Composite view,
			Text textBox){
		...
		if(service.keyCode == 13){
			...
			if(term != null && !term.equals("")){
				...
				if(records == null || records.size() == 0){
					...
					recordQuery.setReferenceView(ReferenceView.Authorities);
