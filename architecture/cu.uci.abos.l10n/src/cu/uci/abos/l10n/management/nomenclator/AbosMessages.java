...
public class AbosMessages {
	...
	public String LABEL_TYPE_OF_COIN;
	...
	public static AbosMessages get() {
		return RWT.NLS.getISO8859_1Encoded(AbosMessageConstants.ABOS_MESSAGES_MANAGEMENT_NOMENCLATOR_CLASS_NAME, AbosMessages.class);
	}
}
